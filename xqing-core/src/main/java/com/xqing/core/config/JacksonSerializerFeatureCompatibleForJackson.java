...
import static com.xqing.core.config.JacksonSerializerFeatureCompatibleForJackson.SerializerFeature.*;
...
public class JacksonSerializerFeatureCompatibleForJackson extends BeanSerializerModifier {
    ...
    public JacksonSerializerFeatureCompatibleForJackson(SerializerFeature... features) {
        int config = 0;
